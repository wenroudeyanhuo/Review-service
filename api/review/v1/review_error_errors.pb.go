...
func IsDbFalied(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_DB_FALIED.String() && e.Code == 500
}

func ErrorDbFalied(format string, args ...interface{}) *errors.Error {
	return errors.New(500, ErrorReason_DB_FALIED.String(), fmt.Sprintf(format, args...))
}
