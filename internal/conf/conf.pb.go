...
type Registry_Consul struct {
	...
	PassDeregister string                 `protobuf:"bytes,2,opt,name=pass_deregister,json=passDeregister,proto3" json:"pass_deregister,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Registry_Consul) GetPassDeregister() string {
	if x != nil {
		return x.PassDeregister
	}
	return ""
}
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\n" +
	"machine_id\x18\x02 \x01(\x03R\tmachineId\"\x8c\x01\n" +
	"\bRegistry\x123\n" +
	"\x06consul\x18\x01 \x01(\v2\x1b.kratos.api.Registry.ConsulR\x06consul\x1aK\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12'\n" +
	"\x0fpass_deregister\x18\x02 \x01(\tR\x0epassDeregisterB#Z!review-service/internal/conf;confb\x06proto3"
